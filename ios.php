<?php 
include './header1.php';
$ios_produits = chercherSysteme('ios');
...
<div class="row1">
        <div class="col-lg-6">
            <div class=" mt-5"><span class="brand-form">SMART.</span><span class="brand-text">vos produits de chez</span> <br> <span class="brand-text">Apple<br></span></div>
        </div>
    </div>
	<div class="row">
		<div class="col-md-12">
			<h2>Produits <b>IOS</b></h2>
