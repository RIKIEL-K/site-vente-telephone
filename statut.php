        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                    ...
                    <a href="modifier_statut2.php?id=<?=$user['id_utilisateur']; ?>" class="btn btn-info">client</a>
                    <a href="modifier_statut.php?id=<?=$user['id_utilisateur']; ?>" class="btn btn-info">admin</a>
                        <!-- <?php if(isset($_GET['id'])){
                            $id_u = $_GET['id'];
                            $id_r = getRoleUtilisateur($id_u);
                            if($id_r == 1){ ?>
